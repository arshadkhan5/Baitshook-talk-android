...
public class LoginIT {
    ...
    public void login() throws InterruptedException {
        ...
        ActivityScenario<GccMainActivity> activityScenario = ActivityScenario.launch(GccMainActivity.class);
        ...
        onView(withId(R.id.switch_account_button)).perform(click());
        onView(withId(R.id.user_name)).check(matches(withText("GccUser One")));
