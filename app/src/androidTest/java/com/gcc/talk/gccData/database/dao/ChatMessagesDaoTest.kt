...
class ChatMessagesDaoTest {
    ...
    private lateinit var chatMessagesDao: GccChatMessagesDao
    ...
    fun test() =
        runTest {
            ...
            // GccUser sees all conversations and clicks on a item. That's how we get a conversation
    ...
    private fun createConversationEntity(accountId: Long, roomName: String): GccConversationEntity {
        val token = (0..10000000).random().toString()

        return GccConversationEntity(
    ...
    private fun createChatMessageEntity(internalConversationId: String, message: String): GccChatMessageEntity {
