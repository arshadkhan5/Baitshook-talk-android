...
package com.gcc.talk.gccLogin.data
...
class LoginRepositoryTest {
    ...
    @Mock
    lateinit var networkLoginDataSource: GccNetworkLoginDataSource

    @Mock
    lateinit var localLoginDataSource: GccLocalLoginDataSource

    // Additional mocks for GccLocalLoginDataSource dependencies
    @Mock
    lateinit var liveData: LiveData<WorkInfo?>

    lateinit var repo: GccLoginRepository

    @Before
    fun setup() {
        MockitoAnnotations.openMocks(this)
        repo = GccLoginRepository(networkLoginDataSource, localLoginDataSource)
    }
    ...
    fun `startLoginFlow handles network SSL exceptions`() =
        runTest {
            ...
            val baseUrl = "https://example.com"
            whenever(networkLoginDataSource.anonymouslyPostLoginRequest(baseUrl))
                .thenReturn(null) // GccNetworkLoginDataSource catches SSL exceptions and returns null
    ...
    // ========== GccLocalLoginDataSource Integration Tests ==========
