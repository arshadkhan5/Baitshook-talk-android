...
class PeerConnectionWrapperTest {
    ...
    private var peerConnectionWrapper: GccPeerConnectionWrapper? = null
    private var mockedPeerConnection: PeerConnection? = null
    private var mockedPeerConnectionFactory: PeerConnectionFactory? = null
    private var mockedSignalingMessageReceiver: GccSignalingMessageReceiver? = null
    private var mockedSignalingMessageSender: GccSignalingMessageSender? = null
    ...
    fun setUp() {
        ...
        mockedSignalingMessageReceiver = Mockito.mock(GccSignalingMessageReceiver::class.java)
        mockedSignalingMessageSender = Mockito.mock(GccSignalingMessageSender::class.java)
    }
    ...
    fun testSendDataChannelMessage() {
        ...
        peerConnectionWrapper = GccPeerConnectionWrapper(
