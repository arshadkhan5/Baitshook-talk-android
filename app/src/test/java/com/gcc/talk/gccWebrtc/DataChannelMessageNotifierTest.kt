...
class DataChannelMessageNotifierTest {
    ...
    private lateinit var notifier: GccDataChannelMessageNotifier
    private lateinit var listener: GccPeerConnectionWrapper.DataChannelMessageListener

    @Before
    fun setUp() {
        notifier = GccDataChannelMessageNotifier()
        listener = mock(GccPeerConnectionWrapper.DataChannelMessageListener::class.java)
    }
