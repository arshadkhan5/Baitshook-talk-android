...
import static com.gcc.talk.gccModels.json.participants.Participant.InCallFlags.DISCONNECTED;
import static com.gcc.talk.gccModels.json.participants.Participant.InCallFlags.IN_CALL;
import static com.gcc.talk.gccModels.json.participants.Participant.InCallFlags.WITH_AUDIO;
import static com.gcc.talk.gccModels.json.participants.Participant.InCallFlags.WITH_VIDEO;
import static com.gcc.talk.gccModels.json.participants.Participant.ParticipantType.GUEST;
import static com.gcc.talk.gccModels.json.participants.Participant.ParticipantType.GUEST_MODERATOR;
import static com.gcc.talk.gccModels.json.participants.Participant.ParticipantType.MODERATOR;
import static com.gcc.talk.gccModels.json.participants.Participant.ParticipantType.OWNER;
import static com.gcc.talk.gccModels.json.participants.Participant.ParticipantType.USER;
...
public class CallParticipantListExternalSignalingTest {
    ...
    private GccCallParticipantList.Observer mockedCallParticipantListObserver;
    ...
    @Before
    public void setUp() {
        GccSignalingMessageReceiver mockedSignalingMessageReceiver = mock(GccSignalingMessageReceiver.class);

        callParticipantList = new GccCallParticipantList(mockedSignalingMessageReceiver);

        mockedCallParticipantListObserver = mock(GccCallParticipantList.Observer.class);
