...
class LocalStateBroadcasterTest {
    ...
    private class LocalStateBroadcaster(
        localCallParticipantModel: GccLocalCallParticipantModel?,
        messageSender: GccMessageSender?
    ) : GccLocalStateBroadcaster(localCallParticipantModel, messageSender) {

        override fun handleCallParticipantAdded(uiState: GccParticipantUiState) {
