...
class LocalStateBroadcasterMcuTest {
    ...
    private var localCallParticipantModel: GccMutableLocalCallParticipantModel? = null
    private var mockedMessageSender: GccMessageSender? = null

    private var localStateBroadcasterMcu: GccLocalStateBroadcasterMcu? = null

    @Before
    fun setUp() {
        localCallParticipantModel = GccMutableLocalCallParticipantModel()
        ...
        mockedMessageSender = Mockito.mock(GccMessageSender::class.java)
    }
    ...
    fun testStateSentWithExponentialBackoffWhenParticipantAdded() {
        ...
        localStateBroadcasterMcu = GccLocalStateBroadcasterMcu(
    ...
    // );
    // Wanted 4 times:
    // -> at com.nextcloud.talk.call.GccMessageSender.send(GccMessageSender.java:63)
    // But was 5 times:
    // -> at com.nextcloud.talk.call.GccLocalStateBroadcasterMcu.sendState(GccLocalStateBroadcasterMcu.java:115)
    // -> at com.nextcloud.talk.call.GccLocalStateBroadcasterMcu.sendState(GccLocalStateBroadcasterMcu.java:115)
    // -> at com.nextcloud.talk.call.GccLocalStateBroadcasterMcu.sendState(GccLocalStateBroadcasterMcu.java:115)
    // -> at com.nextcloud.talk.call.GccLocalStateBroadcasterMcu.sendState(GccLocalStateBroadcasterMcu.java:115)
    // -> at com.nextcloud.talk.call.GccLocalStateBroadcasterMcu.sendState(GccLocalStateBroadcasterMcu.java:115)
    //
    //
    // 	at app//com.nextcloud.talk.call.GccMessageSender.send(GccMessageSender.java:63)
    ...
    private fun createTestParticipantUiState(sessionId: String = "theSessionId"): GccParticipantUiState =
        GccParticipantUiState(
