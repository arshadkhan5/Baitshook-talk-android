...
class LocalCallParticipantModelTest {
    ...
    private var mockedLocalCallParticipantModelObserver: GccLocalCallParticipantModel.Observer? = null

    @Before
    fun setUp() {
        localCallParticipantModel = GccMutableLocalCallParticipantModel()
        mockedLocalCallParticipantModelObserver = Mockito.mock(GccLocalCallParticipantModel.Observer::class.java)
    }
