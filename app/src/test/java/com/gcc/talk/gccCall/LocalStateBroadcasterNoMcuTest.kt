...
class LocalStateBroadcasterNoMcuTest {
    ...
    private lateinit var localCallParticipantModel: GccMutableLocalCallParticipantModel
    private lateinit var mockedMessageSenderNoMcu: GccMessageSenderNoMcu

    private lateinit var localStateBroadcasterNoMcu: GccLocalStateBroadcasterNoMcu
    ...
    fun setUp() {
        ...
        mockedMessageSenderNoMcu = Mockito.mock(GccMessageSenderNoMcu::class.java)
    }
    ...
    fun testStateSentWhenParticipantConnects() =
        testScope.runTest {
            localStateBroadcasterNoMcu = GccLocalStateBroadcasterNoMcu(
