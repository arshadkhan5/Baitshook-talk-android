...
class ConversationConversionTest(private val jsonFileName: String) {
    ...
    private fun checkConversationEntity(conversationEntity: GccConversationEntity, apiVersion: Int) {
    ...
    private fun checkConversationEntityLargerThanV1(conversationEntity: GccConversationEntity) {
    ...
    private fun checkConversationEntityV4(conversationEntity: GccConversationEntity) {
    ...
    private fun checkConversationEntityV1(conversationEntity: GccConversationEntity) {
