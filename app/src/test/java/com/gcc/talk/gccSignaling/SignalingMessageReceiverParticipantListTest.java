...
public class SignalingMessageReceiverParticipantListTest {
    ...
    public void testAddParticipantListMessageListenerWithNullListener() {
        Assert.assertThrows(IllegalArgumentException.class, () -> {
            signalingMessageReceiver.addListener((GccSignalingMessageReceiver.ParticipantListMessageListener) null);
        });
    }

    @Test
    public void testInternalSignalingParticipantListMessageUsersInRoom() {
        GccSignalingMessageReceiver.ParticipantListMessageListener mockedParticipantListMessageListener =
            mock(GccSignalingMessageReceiver.ParticipantListMessageListener.class);
    ...
    public void testInternalSignalingParticipantListMessageAfterRemovingSingleListenerOfSeveral() {
        GccSignalingMessageReceiver.ParticipantListMessageListener mockedParticipantListMessageListener1 =
            mock(GccSignalingMessageReceiver.ParticipantListMessageListener.class);
        GccSignalingMessageReceiver.ParticipantListMessageListener mockedParticipantListMessageListener2 =
            mock(GccSignalingMessageReceiver.ParticipantListMessageListener.class);
        GccSignalingMessageReceiver.ParticipantListMessageListener mockedParticipantListMessageListener3 =
            mock(GccSignalingMessageReceiver.ParticipantListMessageListener.class);
