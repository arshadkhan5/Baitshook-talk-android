...
class ParticipantHandlerTest {
    ...
    private lateinit var signalingMessageReceiver: GccSignalingMessageReceiver
    private lateinit var onParticipantShareScreen: (String?) -> Unit
    private lateinit var onParticipantUnshareScreen: (String?) -> Unit

    private lateinit var handler: GccParticipantHandler
    ...
    fun `Initial state is correct`() =
        runTest {
            ...
            // Then
            val expectedState = GccParticipantUiState(
