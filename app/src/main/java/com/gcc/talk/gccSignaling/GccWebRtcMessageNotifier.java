 ...
 * a GccSignalingMessageReceiver rather than against a WebRtcMessageNotifier.
 */
class GccWebRtcMessageNotifier {
    ...
    private static class WebRtcMessageListenerFrom {
        public final GccSignalingMessageReceiver.WebRtcMessageListener listener;
        public final String sessionId;
        public final String roomType;

        private WebRtcMessageListenerFrom(GccSignalingMessageReceiver.WebRtcMessageListener listener,
                                          String sessionId,
                                          String roomType) {
    ...
    public synchronized void addListener(GccSignalingMessageReceiver.WebRtcMessageListener listener, String sessionId, String roomType) {
        if (listener == null) {
    ...
    public synchronized void removeListener(GccSignalingMessageReceiver.WebRtcMessageListener listener) {
    ...
    private List<GccSignalingMessageReceiver.WebRtcMessageListener> getListenersFor(String sessionId, String roomType) {
        List<GccSignalingMessageReceiver.WebRtcMessageListener> webRtcMessageListeners =
    ...
    public synchronized void notifyOffer(String sessionId, String roomType, String sdp, String nick) {
        for (GccSignalingMessageReceiver.WebRtcMessageListener listener : getListenersFor(sessionId, roomType)) {
