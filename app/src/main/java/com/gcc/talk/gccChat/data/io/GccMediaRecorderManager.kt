 ...
 */
class GccMediaRecorderManager : GccLifecycleAwareManager {

    companion object {
        val TAG: String = GccMediaRecorderManager::class.java.simpleName
     ...
     */
    fun start(context: Context, currentConversation: GccConversationModel) {
    ...
    private fun setVoiceRecordFileName(context: Context, currentConversation: GccConversationModel) {
