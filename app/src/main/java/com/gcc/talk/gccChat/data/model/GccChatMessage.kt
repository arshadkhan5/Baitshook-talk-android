 ...
 */
package com.gcc.talk.gccChat.data.model
...
import com.gcc.talk.gccModels.json.converters.EnumSystemMessageTypeConverter
...
data class GccChatMessage(
    ...
    var sendStatus: GccSendStatus? = null,
                ...
                if (isHashMapEntryEqualTo(individualHashMap, "type", "file")) {
                    ...
                    if (!isVoiceMessage) {
                        if (activeUser != null && activeUser!!.baseUrl != null) {
                            return GccApiUtils.getUrlForFilePreviewWithFileId(
                                activeUser!!.baseUrl!!,
        ...
        object : IUser {
            ...
            override fun getAvatar(): String? =
                when {
                    ...
                    actorType == "users" -> {
                        GccApiUtils.getUrlForAvatar(activeUser!!.baseUrl!!, actorId, true)
                    }
                    ...
                    actorType == "bridged" -> {
                        ...
                        GccApiUtils.getUrlForGuestAvatar(activeUser!!.baseUrl!!, apiId, true)
                    }
                }
        }
    ...
    companion object {
        private const val TAG = "GccChatMessage"
