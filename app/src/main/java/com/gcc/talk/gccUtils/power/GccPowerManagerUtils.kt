 ...
 */
package com.gcc.talk.gccUtils.power
...
class GccPowerManagerUtils {
    ...
    private val proximityLock: GccProximityLock
    ...
    init {
        ...
        proximityLock = GccProximityLock(pm)
    ...
    companion object {
        private val TAG = GccPowerManagerUtils::class.java.simpleName
    }
}
