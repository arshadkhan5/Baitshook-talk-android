...
class GccPlatformPermissionUtilImpl(private val context: Context) : GccPlatformPermissionUtil {
    ...
    companion object {
        private val TAG = GccPlatformPermissionUtilImpl::class.simpleName
    }
}
