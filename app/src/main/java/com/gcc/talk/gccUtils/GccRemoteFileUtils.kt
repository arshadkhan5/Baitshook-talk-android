...
object GccRemoteFileUtils {
    private val TAG = GccRemoteFileUtils::class.java.simpleName

    fun getNewPathIfFileExists(ncApi: GccNcApi, currentUser: GccUser, remotePath: String): String {
    ...
    private fun doesFileExist(ncApi: GccNcApi, currentUser: GccUser, remotePath: String): Observable<Boolean> =
    ...
    private fun getFileNameWithoutCollision(ncApi: GccNcApi, currentUser: GccUser, remotePath: String): String {
