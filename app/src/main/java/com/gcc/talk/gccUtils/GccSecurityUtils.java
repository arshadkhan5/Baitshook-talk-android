...
public class GccSecurityUtils {
    private static final String TAG = "GccSecurityUtils";
    ...
    public static boolean checkIfWeAreAuthenticated(String screenLockTimeout) {
        try {
            ...
            // GccUser is not authenticated, let's authenticate with device credentials.
            return false;
    ...
    private static int getIntegerFromStringTimeout(String validity) {
        Resources resources = GccTalkApplication.Companion.getSharedApplication().getResources();
