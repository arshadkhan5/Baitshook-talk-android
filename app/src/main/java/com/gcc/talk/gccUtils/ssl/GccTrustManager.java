...
public class GccTrustManager implements X509TrustManager {
    private static final String TAG = "GccTrustManager";

    private final File keystoreFile;
    private X509TrustManager systemTrustManager = null;
    private KeyStore trustedKeyStore = null;

    public GccTrustManager() {
        keystoreFile = new File(GccTalkApplication.Companion.getSharedApplication()
        ...
        if (systemTrustManager != null) {
            ...
            try {
                ...
                if (!isCertInTrustStore(x509Certificate)) {
                    EventBus.getDefault().post(new GccCertificateEvent(x509Certificate, this,
                                                                       null));
