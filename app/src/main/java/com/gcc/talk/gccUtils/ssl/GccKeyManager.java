 ...
 */
package com.gcc.talk.gccUtils.ssl;
...
public class GccKeyManager implements X509KeyManager {
    private static final String TAG = "GccKeyManager";
    private final X509KeyManager keyManager;

    private GccUserManager userManager;
    private GccAppPreferences appPreferences;
    private Context context;

    public GccKeyManager(X509KeyManager keyManager, GccUserManager userManager, GccAppPreferences appPreferences) {
        this.keyManager = keyManager;
        this.userManager = userManager;
        this.appPreferences = appPreferences;

        context = GccTalkApplication.Companion.getSharedApplication().getApplicationContext();
    }

    @Override
    public String chooseClientAlias(String[] strings, Principal[] principals, Socket socket) {
        String alias;
        GccUser currentUser = userManager.getCurrentUser().blockingGet();
        if ((currentUser != null &&
    ...
    private String[] getClientAliases() {
        ...
        List<GccUser> userEntities = userManager.getUsers().blockingGet();
