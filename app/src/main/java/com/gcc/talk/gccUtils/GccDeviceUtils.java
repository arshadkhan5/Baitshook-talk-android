...
public class GccDeviceUtils {
    private static final String TAG = "GccDeviceUtils";
        ...
        if ("xiaomi".equalsIgnoreCase(Build.MANUFACTURER) || "meizu".equalsIgnoreCase(Build.MANUFACTURER)) {
            try {
                ...
                if (appOpsUtilsClass != null) {
                    ...
                    if (setApplicationAutoStartMethod != null) {
                        Context applicationContext = GccTalkApplication
                            .Companion
            ...
            try {
                ...
                if (protectAppControlClass != null) {
                    Context applicationContext = GccTalkApplication.Companion.getSharedApplication().getApplicationContext();
