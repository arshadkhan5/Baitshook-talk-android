...
import com.gcc.talk.PhoneUtils.isPhoneNumber
...
import com.gcc.talk.gccUtils.GccApiUtils.getUrlForAvatar
import com.gcc.talk.gccUtils.GccApiUtils.getUrlForFederatedAvatar
import com.gcc.talk.gccUtils.GccApiUtils.getUrlForGuestAvatar
import com.gcc.talk.gccUtils.preferences.GccAppPreferencesImpl
import com.gcc.talk.gccUtils.text.GccSpans.MentionChipSpan
...
object GccDisplayUtils {
    private val TAG = GccDisplayUtils::class.java.simpleName
    ...
    fun searchAndReplaceWithMentionSpan(
        ...
        val clickableSpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                EventBus.getDefault().post(GccUserMentionClickEvent(id))
            }
        }
    ...
    fun loadAvatarImage(user: GccUser?, avatarImageView: ImageView?, deleteCache: Boolean) {
    ...
    @StringRes
    fun getSortOrderStringId(sortOrder: GccFileSortOrder): Int =
        when (sortOrder.name) {
            GccFileSortOrder.SORT_Z_TO_A_ID -> R.string.menu_item_sort_by_name_z_a
            GccFileSortOrder.SORT_NEW_TO_OLD_ID -> R.string.menu_item_sort_by_date_newest_first
            GccFileSortOrder.SORT_OLD_TO_NEW_ID -> R.string.menu_item_sort_by_date_oldest_first
            GccFileSortOrder.SORT_BIG_TO_SMALL_ID -> R.string.menu_item_sort_by_size_biggest_first
            GccFileSortOrder.SORT_SMALL_TO_BIG_ID -> R.string.menu_item_sort_by_size_smallest_first
            GccFileSortOrder.SORT_A_TO_Z_ID -> R.string.menu_item_sort_by_name_a_z
