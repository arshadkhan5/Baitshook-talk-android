...
object GccApiUtils {
    private val TAG = GccApiUtils::class.java.simpleName
    const val API_V1 = 1
    ...
    @Deprecated(
        "This is only supported on API v1-3, in API v4+ please use " +
            "{@link GccApiUtils#getUrlForAttendees(int, String, String)} instead."
    )
    ...
    private fun getRetrofitBucketForContactsSearch(baseUrl: String, searchQuery: String?): GccRetrofitBucket {
        var query = searchQuery
        val retrofitBucket = GccRetrofitBucket()
    ...
    fun getRetrofitBucketForContactsSearchFor14(baseUrl: String, searchQuery: String?): GccRetrofitBucket {
    ...
    @Throws(GccNoSupportedApiException::class)
    fun getCallApiVersion(capabilities: GccUser, versions: IntArray): Int =
        getConversationApiVersion(capabilities, versions)

    @JvmStatic
    @Throws(GccNoSupportedApiException::class)
    @Suppress("ReturnCount")
    fun getConversationApiVersion(user: GccUser, versions: IntArray): Int {
        var hasApiV4 = false
        ...
        throw GccNoSupportedApiException()
    }

    @JvmStatic
    @Throws(GccNoSupportedApiException::class)
    @Suppress("ReturnCount")
    fun getSignalingApiVersion(user: GccUser, versions: IntArray): Int {
    ...
    fun getUrlForReminder(user: GccUser, roomToken: String, messageId: String, version: Int): String {
