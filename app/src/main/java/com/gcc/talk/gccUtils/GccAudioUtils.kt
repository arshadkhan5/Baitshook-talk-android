...
/**
 * GccAudioUtils are for processing raw audio using android's low level APIs, for more information read here
 * [MediaCodec documentation](https://developer.android.com/reference/android/media/MediaCodec)
 */
object GccAudioUtils : DefaultLifecycleObserver {
    private val TAG = GccAudioUtils::class.java.simpleName
