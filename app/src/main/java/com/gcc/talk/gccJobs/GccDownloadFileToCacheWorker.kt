...
class GccDownloadFileToCacheWorker(val context: Context, workerParameters: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        try {
            ...
            val url = GccApiUtils.getUrlForFileDownload(baseUrl, userId, remotePath)
    ...
    private fun downloadFile(currentUser: GccUser, url: String, fileName: String): Result {
