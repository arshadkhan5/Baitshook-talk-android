 ...
 */
package com.gcc.talk.gccFullscreenfile

import android.content.Intent
import android.os.Bundle
import android.util.Log
import com.gcc.talk.gccUi.SwipeToCloseLayout
...
import com.gcc.talk.databinding.ActivityFullScreenImageBinding
...
class GccFullScreenImageActivity : AppCompatActivity() {
    ...
    private fun displayImage(path: String) {
        ...
        val bitmap = GccBitmapShrinker.shrinkBitmap(path, doubleScreenWidth, doubleScreenHeight)
    ...
    companion object {
        private const val TAG = "GccFullScreenImageActivity"
