 ...
 * connections.
 */
public abstract class GccMessageSender {

    private final GccSignalingMessageSender signalingMessageSender;

    private final Set<String> callParticipantSessionIds;

    protected final List<GccPeerConnectionWrapper> peerConnectionWrappers;

    public GccMessageSender(GccSignalingMessageSender signalingMessageSender,
    ...
    protected GccPeerConnectionWrapper getPeerConnectionWrapper(String sessionId) {
