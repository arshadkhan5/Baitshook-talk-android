...
class GccLocalStateBroadcasterNoMcu(
    private val localCallParticipantModel: GccLocalCallParticipantModel,
    private val messageSender: GccMessageSenderNoMcu,
    ...
    private inner class IceConnectionStateObserver(val uiState: GccParticipantUiState) {
        ...
        private fun handleStateChange(uiState: GccParticipantUiState) {
