 ...
 * <p>
 * The GccCallParticipantList adds a listener for participant list messages as soon as it is created and starts tracking
 * the call participants until destroyed. Notifications about the changes can be received by adding an observer to the
 * GccCallParticipantList; note that no sorting is guaranteed on the participants.
 */
public class GccCallParticipantList {
    ...
    private final GccSignalingMessageReceiver.ParticipantListMessageListener participantListMessageListener =
            new GccSignalingMessageReceiver.ParticipantListMessageListener() {
    ...
    public GccCallParticipantList(GccSignalingMessageReceiver signalingMessageReceiver) {
