...
fun ParticipantGrid(
    ...
    eglBase: EglBase?,
    participantUiStates: List<GccParticipantUiState>,
...
fun getTestParticipants(numberOfParticipants: Int): List<GccParticipantUiState> {
    val participantList = mutableListOf<GccParticipantUiState>()
    for (i: Int in 1..numberOfParticipants) {
        val participant = GccParticipantUiState(
