 ...
 */
public class GccLocalStateBroadcasterMcu extends GccLocalStateBroadcaster {
    ...
    public GccLocalStateBroadcasterMcu(GccLocalCallParticipantModel localCallParticipantModel,
    ...
    @Override
    public void handleCallParticipantAdded(GccParticipantUiState uiState) {
        if (sendStateWithRepetition != null) {
            sendStateWithRepetition.dispose();
        }
