 ...
 * <p>
 * Clients of the model can observe it with GccLocalCallParticipantModel.Observer to be notified when any value changes.
 ...
 */
public class GccLocalCallParticipantModel {

    protected final GccLocalCallParticipantModelNotifier localCallParticipantModelNotifier =
        new GccLocalCallParticipantModelNotifier();
    ...
    public GccLocalCallParticipantModel() {
     ...
     * @see GccLocalCallParticipantModel#addObserver(Observer, Handler)
     */
