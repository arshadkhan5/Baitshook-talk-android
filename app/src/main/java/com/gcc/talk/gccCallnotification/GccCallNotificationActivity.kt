 ...
 */
package com.gcc.talk.gccCallnotification
...
import com.gcc.talk.gccActivities.GccCallBaseActivity
...
import com.gcc.talk.databinding.CallNotificationActivityBinding
...
class GccCallNotificationActivity : GccCallBaseActivity() {
    @JvmField
    @Inject
    ...
    private var userBeingCalled: GccUser? = null
    ...
    private fun handleExtras() {
        ...
        notificationTimestamp = extras.getInt(GccBundleKeys.KEY_NOTIFICATION_TIMESTAMP)
        displayName = extras.getString(GccBundleKeys.KEY_CONVERSATION_DISPLAY_NAME, "")
        callFlag = extras.getInt(GccBundleKeys.KEY_CALL_FLAG)
        isOneToOneCall = extras.getBoolean(KEY_ROOM_ONE_TO_ONE)
        conversationName = extras.getString(GccBundleKeys.KEY_CONVERSATION_NAME, "")
        internalUserId = extras.getLong(GccBundleKeys.KEY_INTERNAL_USER_ID)
    }
    ...
    private fun setupNotificationCanceledRoutine() {
        ...
        notificationHandler.post(object : Runnable {
            override fun run() {
                if (GccNotificationUtils.isNotificationVisible(context, notificationTimestamp!!.toInt())) {
    ...
    companion object {
        private val TAG = GccCallNotificationActivity::class.simpleName
