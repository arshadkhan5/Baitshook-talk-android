...
package com.gcc.talk.gccThreadsoverview
...
import com.gcc.talk.gccChat.GccChatActivity.Companion.TAG
...
import com.gcc.talk.gccThreadsoverview.components.ThreadRow
...
class ThreadsOverviewActivity : GccBaseActivity() {
    ...
    lateinit var threadsOverviewViewModel: GccThreadsOverviewViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        threadsOverviewViewModel = ViewModelProvider(
            this,
            viewModelFactory
        )[GccThreadsOverviewViewModel::class.java]
...
fun ThreadsOverviewScreen(
    uiState: GccThreadsOverviewViewModel.ThreadsListUiState,
    onThreadClick: (roomToken: String, threadId: Int) -> Unit
) {
    when (val state = uiState) {
        is GccThreadsOverviewViewModel.ThreadsListUiState.None -> {
            LoadingIndicator()
        }

        is GccThreadsOverviewViewModel.ThreadsListUiState.Success -> {
            ThreadsList(
        ...
        is GccThreadsOverviewViewModel.ThreadsListUiState.Error -> {
