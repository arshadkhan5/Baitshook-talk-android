...
package com.gcc.talk.gccData.database.model
...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(
            entity = GccConversationEntity::class,
...
data class GccChatMessageEntity(
    ...
    @ColumnInfo(name = "sendStatus") var sendStatus: GccSendStatus? = null,
    @ColumnInfo(name = "silent") var silent: Boolean = false,
    @ColumnInfo(name = "systemMessage") var systemMessageType: GccChatMessage.SystemMessageType,
