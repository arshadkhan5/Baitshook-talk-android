...
object Migrations {
    ...
    fun migrateToRoom(db: SupportSQLiteDatabase) {
        ...
        db.execSQL(
            "INSERT INTO ArbitraryStorage_new (" +
                ...
                "SELECT " +
                "accountIdentifier, \"key\", object, value " +
                "FROM GccArbitraryStorage"
        )
        // Remove the old table
        db.execSQL("DROP TABLE GccUser")
        db.execSQL("DROP TABLE GccArbitraryStorage")

        // Change the table name to the correct one
        db.execSQL("ALTER TABLE User_new RENAME TO GccUser")
        db.execSQL("ALTER TABLE ArbitraryStorage_new RENAME TO GccArbitraryStorage")
    }
    ...
    fun migrateToDualPrimaryKeyArbitraryStorage(db: SupportSQLiteDatabase) {
        ...
        // Change the table name to the correct one
        db.execSQL("ALTER TABLE ArbitraryStorage_dualPK RENAME TO GccArbitraryStorage")
    }
    ...
    fun migrateToOfflineSupport(db: SupportSQLiteDatabase) {
        db.execSQL(
            "CREATE TABLE IF NOT EXISTS Conversations (" +
                ...
                "FOREIGN KEY(`accountId`) REFERENCES `GccUser`(`id`) " +
