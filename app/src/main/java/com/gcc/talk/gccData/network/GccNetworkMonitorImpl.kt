...
package com.gcc.talk.gccData.network
...
@Singleton
class GccNetworkMonitorImpl @Inject constructor(private val context: Context) : GccNetworkMonitor {
    ...
    companion object {
        private val TAG = GccNetworkMonitorImpl::class.java.simpleName
