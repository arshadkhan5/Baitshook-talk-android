...
class GccLinkedHashMapConverter {

    private val converter = GccLinkedHashMapStringIntConverter()
    ...
    fun stringToLinkedHashMap(value: String?): LinkedHashMap<String, Int> {
        ...
        return try {
            ...
            Log.e("GccLinkedHashMapConverter", "Error parsing string: $value to linkedHashMap $e")
            linkedMapOf()
        }
    }
