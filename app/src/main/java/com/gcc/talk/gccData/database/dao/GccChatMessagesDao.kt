...
interface GccChatMessagesDao {
    ...
    fun getMessagesForConversation(internalConversationId: String): Flow<List<GccChatMessageEntity>>
    ...
    fun getTempMessagesForConversation(internalConversationId: String): Flow<List<GccChatMessageEntity>>
    ...
    fun getTempMessageForConversation(
        ...
        referenceId: String,
        threadId: Long?
    ): Flow<GccChatMessageEntity?>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun upsertChatMessages(chatMessages: List<GccChatMessageEntity>)

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun upsertChatMessage(chatMessage: GccChatMessageEntity)
    ...
    fun getChatMessageForConversation(internalConversationId: String, messageId: Long): Flow<GccChatMessageEntity>
    ...
    suspend fun getChatMessageEntity(internalConversationId: String, messageId: Long): GccChatMessageEntity?
    ...
    @Update
    fun updateChatMessage(message: GccChatMessageEntity)
    ...
    fun getMessagesFromIds(messageIds: List<Long>): Flow<List<GccChatMessageEntity>>
