...
import com.gcc.talk.gccUi.ComposeChatAdapter
import com.gcc.talk.gccUtils.preview.GccComposePreviewUtils

@Composable
fun ContextChatView(context: Context, contextViewModel: GccContextChatViewModel) {
    ...
    when (contextChatMessagesState) {
        GccContextChatViewModel.ContextChatRetrieveUiState.None -> {}
        is GccContextChatViewModel.ContextChatRetrieveUiState.Success -> {
        ...
        is GccContextChatViewModel.ContextChatRetrieveUiState.Error -> {
...
fun ContextChatSuccessView(
    visible: Boolean,
    context: Context,
    contextChatRetrieveUiStateSuccess: GccContextChatViewModel.ContextChatRetrieveUiState.Success,
    onDismiss: () -> Unit
) {
