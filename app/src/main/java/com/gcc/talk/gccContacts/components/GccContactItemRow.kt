...
@Composable
fun ContactItemRow(contact: AutocompleteUser, contactsViewModel: GccContactsViewModel, context: Context) {
    ...
    when (roomUiState) {
        is GccContactsViewModel.RoomUiState.Success -> {
            val conversation = (roomUiState as GccContactsViewModel.RoomUiState.Success).conversation
            val bundle = Bundle()
        ...
        is GccContactsViewModel.RoomUiState.Error -> {
            val errorMessage = (roomUiState as GccContactsViewModel.RoomUiState.Error).message
            Box(
        ...
        is GccContactsViewModel.RoomUiState.None -> {}
    }
}
