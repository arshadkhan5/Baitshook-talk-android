...
import com.gcc.talk.gccConversationcreation.ConversationCreationActivity
import com.gcc.talk.gccOpenconversations.GccListOpenConversationsActivity
    ...
    Column {
        ...
        Row(
            modifier = Modifier
                ...
                .clickable {
                    val intent = Intent(context, GccListOpenConversationsActivity::class.java)
                    context.startActivity(intent)
                },
            verticalAlignment = Alignment.CenterVertically
        ) {
