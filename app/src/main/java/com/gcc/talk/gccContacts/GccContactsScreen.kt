...
import com.gcc.talk.gccContacts.components.ContactsAppBar
import com.gcc.talk.gccContacts.components.ContactsList
import com.gcc.talk.gccContacts.components.ContactsSearchAppBar
import com.gcc.talk.gccContacts.components.ConversationCreationOptions

@Composable
fun ContactsScreen(contactsViewModel: GccContactsViewModel, uiState: GccContactsViewModel.ContactsUiState) {
