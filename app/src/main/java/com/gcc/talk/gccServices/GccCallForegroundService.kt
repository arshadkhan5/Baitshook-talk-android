 ...
 */
package com.gcc.talk.gccServices
...
class GccCallForegroundService : Service() {
    ...
    private fun buildNotification(conversationName: String?, callExtras: Bundle?): Notification {
        val channelId = GccNotificationUtils.NotificationChannels.NOTIFICATION_CHANNEL_CALLS_V4.name
    ...
    private fun ensureNotificationChannel() {
        val app = GccTalkApplication.sharedApplication ?: return
        GccNotificationUtils.registerNotificationChannels(applicationContext, app.appPreferences)
    }

    private fun createContentIntent(callExtras: Bundle?): PendingIntent {
        val intent = Intent(this, GccCallActivity::class.java).apply {
    ...
    companion object {
        ...
        fun start(context: Context, conversationName: String?, callIntentExtras: Bundle?) {
            val serviceIntent = Intent(context, GccCallForegroundService::class.java).apply {
        ...
        fun stop(context: Context) {
            context.stopService(Intent(context, GccCallForegroundService::class.java))
        }
    }
}
