...
public class GccEventStatus {
    private long userId;
    private EventType eventType;
    private boolean allGood;

    public GccEventStatus(long userId, EventType eventType, boolean allGood) {
        this.userId = userId;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GccEventStatus)) {
            return false;
        }
        final GccEventStatus other = (GccEventStatus) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GccEventStatus;
    }
    ...
    public String toString() {
        return "GccEventStatus(userId=" + this.getUserId() + ", eventType=" + this.getEventType() + ", allGood=" + this.isAllGood() + ")";
    }
