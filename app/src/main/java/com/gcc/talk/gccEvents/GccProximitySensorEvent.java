...
public class GccProximitySensorEvent {
    private final ProximitySensorEventType proximitySensorEventType;

    public GccProximitySensorEvent(ProximitySensorEventType proximitySensorEventType) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GccProximitySensorEvent)) {
            return false;
        }
        final GccProximitySensorEvent other = (GccProximitySensorEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GccProximitySensorEvent;
    }
    ...
    public String toString() {
        return "GccProximitySensorEvent(proximitySensorEventType=" + this.getProximitySensorEventType() + ")";
    }
