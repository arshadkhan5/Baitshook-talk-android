...
package com.gcc.talk.gccAccount.data

import android.os.Bundle
import android.text.TextUtils
import android.util.Log
import com.gcc.talk.gccAccount.data.io.GccLocalLoginDataSource
import com.gcc.talk.gccAccount.data.model.LoginCompletion
import com.gcc.talk.gccAccount.data.model.LoginResponse
...
class GccLoginRepository(val network: GccNetworkLoginDataSource, val local: GccLocalLoginDataSource) {

    companion object {
        val TAG: String = GccLoginRepository::class.java.simpleName
    ...
    fun parseAndLogin(loginData: LoginCompletion): Bundle? {
        if (local.checkIfUserIsScheduledForDeletion(loginData)) {
            // however the user is not yet deleted, just start GccAccountRemovalWorker again to make sure to delete it.
