...
package com.gcc.talk.gccAccount.data.network
...
class GccNetworkLoginDataSource(val okHttpClient: OkHttpClient) {

    companion object {
        val TAG: String = GccNetworkLoginDataSource::class.java.simpleName
    }
