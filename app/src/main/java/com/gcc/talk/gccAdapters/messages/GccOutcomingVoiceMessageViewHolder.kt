...
class GccOutcomingVoiceMessageViewHolder(outcomingView: View) :
    MessageHolders.OutcomingTextMessageViewHolder<GccChatMessage>(outcomingView),
    ...
    private fun handleResetVoiceMessageState(message: GccChatMessage) {
    ...
    private fun handleIsDownloadingVoiceMessageState(message: GccChatMessage) {
