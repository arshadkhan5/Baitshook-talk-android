...
import com.gcc.talk.gccAdapters.items.GccParticipantItem.ParticipantItemViewHolder
import com.gcc.talk.gccApplication.GccTalkApplication.Companion.sharedApplication
import com.gcc.talk.gccData.user.model.GccUser
import com.gcc.talk.databinding.RvItemConversationInfoParticipantBinding
import com.gcc.talk.gccExtensions.loadDefaultAvatar
import com.gcc.talk.gccExtensions.loadDefaultGroupCallAvatar
import com.gcc.talk.gccExtensions.loadFederatedUserAvatar
import com.gcc.talk.gccExtensions.loadFirstLetterAvatar
import com.gcc.talk.gccExtensions.loadPhoneAvatar
import com.gcc.talk.gccExtensions.loadTeamAvatar
...
import com.gcc.talk.gccModels.json.participants.Participant.InCallFlags
import com.gcc.talk.gccModels.json.status.StatusType
...
import com.gcc.talk.gccUtils.GccDisplayUtils.convertDpToPixel
...
class GccParticipantItem(
    ...
    companion object {
        private val TAG = GccParticipantItem::class.simpleName
