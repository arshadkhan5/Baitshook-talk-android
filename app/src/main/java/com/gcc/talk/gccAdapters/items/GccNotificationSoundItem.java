...
import com.gcc.talk.databinding.RvItemNotificationSoundBinding;
...
public class GccNotificationSoundItem extends AbstractFlexibleItem<GccNotificationSoundItem.NotificationSoundItemViewHolder> {

    private final String notificationSoundName;
    private final String notificationSoundUri;

    public GccNotificationSoundItem(String notificationSoundName, String notificationSoundUri) {
    ...
    public boolean equals(Object o) {
        ...
        GccNotificationSoundItem that = (GccNotificationSoundItem) o;
