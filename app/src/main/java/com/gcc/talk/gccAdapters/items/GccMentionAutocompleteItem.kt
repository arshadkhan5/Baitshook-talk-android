...
class GccMentionAutocompleteItem(
    mention: Mention,
    ...
    override fun equals(o: Any?): Boolean =
        if (o is GccMentionAutocompleteItem) {
    ...
    private fun alignUsernameVertical(holder: ParticipantItemViewHolder, densityPixelsFromTop: Float) {
        ...
        layoutParams.topMargin = GccDisplayUtils.convertDpToPixel(densityPixelsFromTop, context).toInt()
