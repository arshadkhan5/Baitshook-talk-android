...
import com.gcc.talk.gccAdapters.items.GccConversationItem.ConversationItemViewHolder
...
import com.gcc.talk.gccChat.data.model.GccChatMessage.MessageType
import com.gcc.talk.gccData.database.mappers.asModel
import com.gcc.talk.gccData.user.model.GccUser
import com.gcc.talk.databinding.RvItemConversationWithLastMessageBinding
...
class GccConversationItem(
    val model: GccConversationModel,
    private val user: GccUser,
    private val context: Context,
    private val viewThemeUtils: ViewThemeUtils
) : AbstractFlexibleItem<ConversationItemViewHolder>(),
    ISectionable<ConversationItemViewHolder, GccGenericTextHeaderItem?>,
    IFilterable<String?> {
    private var header: GccGenericTextHeaderItem? = null
    ...
    constructor(
        ...
        genericTextHeaderItem: GccGenericTextHeaderItem?,
    ...
    override fun equals(other: Any?): Boolean {
        if (other is GccConversationItem) {
    ...
    override fun bindViewHolder(
        ...
        if (ConversationEnums.ConversationType.ROOM_SYSTEM !== model.type) {
            val size = GccDisplayUtils.convertDpToPixel(STATUS_SIZE_IN_DP, appContext)
    ...
    fun authorName(chatMessage: GccChatMessage): String {
    ...
    companion object {
        const val VIEW_TYPE = GccFlexibleItemViewType.CONVERSATION_ITEM
