...
import com.gcc.talk.databinding.ItemCustomIncomingPollMessageBinding
...
class GccIncomingPollMessageViewHolder(incomingView: View, payload: Any) :
    ...
    companion object {
        private val TAG = GccIncomingPollMessageViewHolder::class.java.simpleName
    }
}
