...
import com.gcc.talk.databinding.ItemCustomIncomingDeckCardMessageBinding
...
class GccIncomingDeckCardViewHolder(incomingView: View, payload: Any) :
    MessageHolders
        .IncomingTextMessageViewHolder<GccChatMessage>(incomingView, payload) {
    ...
    private fun showDeckCard(message: GccChatMessage) {
    ...
    companion object {
        private val TAG = GccIncomingDeckCardViewHolder::class.java.simpleName
    }
}
