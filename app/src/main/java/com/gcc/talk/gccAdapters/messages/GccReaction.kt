...
class GccReaction {
    ...
    fun showReactions(
        ...
        clickOnReaction: (message: GccChatMessage, emoji: String) -> Unit,
        longClickOnReaction: (message: GccChatMessage) -> Unit,
        ...
        if (message.reactions != null && message.reactions!!.isNotEmpty()) {
            ...
            val paddingSide = GccDisplayUtils.convertDpToPixel(EMOJI_AND_AMOUNT_PADDING_SIDE, context).toInt()
            val paddingTop = GccDisplayUtils.convertDpToPixel(WRAPPER_PADDING_TOP, context).toInt()
            val paddingBottom = GccDisplayUtils.convertDpToPixel(WRAPPER_PADDING_BOTTOM, context).toInt()
    ...
    private fun getEmojiWithAmountWrapperLayout(
        ...
        emojiContainer.setStrokeWidth(GccDisplayUtils.convertDpToPixel(EMOJI_CONTAINER_STROKE_WIDTH, context).toInt())
    ...
    private fun getWrapperLayoutParams(
        ...
        wrapperParams.marginEnd = GccDisplayUtils.convertDpToPixel(endMarginInDp, context).toInt()
    ...
    private fun getAmountLayoutParams(context: Context): LinearLayout.LayoutParams {
        ...
        amountParams.marginStart = GccDisplayUtils.convertDpToPixel(AMOUNT_START_MARGIN, context).toInt()
        return amountParams
    }
