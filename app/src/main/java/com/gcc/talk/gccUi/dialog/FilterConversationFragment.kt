...
import com.gcc.talk.databinding.DialogFilterConversationBinding
...
class FilterConversationFragment : DialogFragment() {
    ...
    private fun setUpListeners() {
        ...
        binding.buttonClose.setOnClickListener {
            ...
            if (noFiltersActive) {
                (requireActivity() as GccConversationsListActivity).showOnlyNearFutureEvents()
            }
            dismiss()
        }
    }
    ...
    private fun processSubmit() {
        ...
        (requireActivity() as GccConversationsListActivity).filterConversation()
    }
