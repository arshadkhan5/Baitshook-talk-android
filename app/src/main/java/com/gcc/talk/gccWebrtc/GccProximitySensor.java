...
/**
 * GccProximitySensor manages functions related to the proximity sensor in
 * the app.
 ...
 */
public class GccProximitySensor implements SensorEventListener {
    private static final String TAG = "GccProximitySensor";
    ...
    private GccProximitySensor(Context context, Runnable sensorStateListener) {
     ...
     * Construction
     */
    static GccProximitySensor create(Context context, Runnable sensorStateListener) {
        return new GccProximitySensor(context, sensorStateListener);
    }
