...
public class GccWebRtcBluetoothManager {
    private static final String TAG = GccWebRtcBluetoothManager.class.getSimpleName();
    ...
    private final GccWebRtcAudioManager webRtcAudioManager;
    ...
    protected GccWebRtcBluetoothManager(Context context, GccWebRtcAudioManager audioManager) {
        Log.d(TAG, "ctor");
     ...
     * Construction.
     */
    static GccWebRtcBluetoothManager create(Context context, GccWebRtcAudioManager audioManager) {
        return new GccWebRtcBluetoothManager(context, audioManager);
    }
    ...
    protected void registerReceiver(BroadcastReceiver receiver, IntentFilter filter) {
        GccContextExtensionsKt.registerBroadcastReceiver(
            apprtcContext,
            receiver,
            filter,
            GccReceiverFlag.Exported);
    }
