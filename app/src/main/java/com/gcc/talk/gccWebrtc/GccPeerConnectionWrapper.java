...
public class GccPeerConnectionWrapper {

    private static final String TAG = GccPeerConnectionWrapper.class.getCanonicalName();

    private final GccSignalingMessageReceiver signalingMessageReceiver;
    private final WebRtcMessageListener webRtcMessageListener = new WebRtcMessageListener();

    private final GccSignalingMessageSender signalingMessageSender;

    private final GccDataChannelMessageNotifier dataChannelMessageNotifier = new GccDataChannelMessageNotifier();

    private final GccPeerConnectionNotifier peerConnectionNotifier = new GccPeerConnectionNotifier();
    ...
    public GccPeerConnectionWrapper(PeerConnectionFactory peerConnectionFactory,
                                    List<PeerConnection.IceServer> iceServerList,
                                    MediaConstraints mediaConstraints,
                                    String sessionId, String localSession, @Nullable MediaStream localStream,
                                    boolean isMCUPublisher, boolean hasMCU, String videoStreamType,
                                    GccSignalingMessageReceiver signalingMessageReceiver,
                                    GccSignalingMessageSender signalingMessageSender) {
    ...
    private class WebRtcMessageListener implements GccSignalingMessageReceiver.WebRtcMessageListener {
        ...
        private void onOfferOrAnswer(String type, String sdp) {
            ...
            String sessionDescriptionStringWithPreferredCodec = GccWebRTCUtils.preferCodec(sdp, "H264", isAudio);
    ...
    private class DataChannelObserver implements DataChannel.Observer {
        ...
        public void onStateChange() {
            synchronized (GccPeerConnectionWrapper.this) {
    ...
    private class SdpObserver implements org.webrtc.SdpObserver {
        ...
        public void onCreateSuccess(SessionDescription sessionDescription) {
            ...
            SessionDescription sessionDescriptionWithPreferredCodec;
            String sessionDescriptionStringWithPreferredCodec = GccWebRTCUtils.preferCodec
