...
import com.gcc.talk.gccModels.json.participants.TalkBanOverall
import com.gcc.talk.gccModels.json.profile.ProfileOverall
import com.gcc.talk.gccModels.json.status.StatusOverall
import com.gcc.talk.gccModels.json.testNotification.TestNotificationOverall
...
interface GccNcApiCoroutines {
    ...
    suspend fun createRoomWithBody(
        @Header("Authorization") authorization: String?,
        @Url url: String?,
        @Body roomRequest: GccCreateRoomRequest
    ): RoomOverall
